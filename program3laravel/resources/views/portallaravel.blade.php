...
<div id="body">
        <div id="inisiasi">
            ...
            <button type="submit" id="tampilkan" onclick="tampilDalamProdi()">Tampilkan</button>
        </div>
...
<script>
    ...
    // Fetch data json dari route get_matakuliah_dalam_prodi
    $.ajax({
        url: '/get_matakuliah_dalam_prodi',
        type: 'GET',
        dataType: 'json',
    ...
    // Fetch data json dari route get_matakuliah_luar_prodi
    $.ajax({
        url: '/get_matakuliah_luar_prodi',
        type: 'GET',
        dataType: 'json',
        success: function(data){  
            arrayJsonLuar = data
